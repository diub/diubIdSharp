...
namespace IdSharp.Tagging.ID3v2 {
	...
	public interface IFrameContainer : INotifyPropertyChanged, INotifyInvalidData {
		...
		BindingList<IUniqueFileIdentifier> UniqueFileIdentifierList {
			get;
		}
		...
		string InternetRadioStationName {
			get; set;
		}
		...
		string InternetRadioStationOwner {
			get; set;
		}
		...
		string OriginalReleaseTimestamp {
			get; set;
		}
		...
		BindingList<ITXXXFrame> UserDefinedText {
			get;
		}
		...
		BindingList<IUrlFrame> CommercialInfoUrlList {
			get;
		}
		...
		BindingList<IUrlFrame> ArtistUrlList {
			get;
		}
		...
		string InternetRadioStationUrl {
			get; set;
		}
		...
		BindingList<IWXXXFrame> UserDefinedUrlList {
			get;
		}
		...
		IInvolvedPersonList InvolvedPersonList {
			get;
		}
		...
		IMusicCDIdentifier MusicCDIdentifier {
			get;
		}
		...
		IMpegLookupTable MpegLookupTable {
			get;
		}
		...
		ISynchronizedTempoCodes SynchronizedTempoCodeList {
			get;
		}
		...
		BindingList<IUnsynchronizedText> UnsynchronizedLyricsList {
			get;
		}
		...
		BindingList<ISynchronizedText> SynchronizedLyrics {
			get;
		}
		...
		BindingList<IComments> CommentsList {
			get;
		}
		...
		BindingList<IComments> iTunesCommentsList {
			get;
		}
		...
		BindingList<IRelativeVolumeAdjustment> RelativeVolumeAdjustmentList {
			get;
		}
		...
		BindingList<IEqualizationList> EqualizationList {
			get;
		}
		...
		BindingList<IAttachedPicture> PictureList {
			get;
		}
		...
		BindingList<IGeneralEncapsulatedObject> GeneralEncapsulatedObjectList {
			get;
		}
		...
		BindingList<IPopularimeter> PopularimeterList {
			get;
		}
		...
		IRecommendedBufferSize RecommendedBufferSize {
			get;
		}
		...
		BindingList<IAudioEncryption> AudioEncryptionList {
			get;
		}
		...
		BindingList<ILinkedInformation> LinkedInformationList {
			get;
		}
		...
		IPositionSynchronization PositionSynchronization {
			get;
		}
		...
		IAudioSeekPointIndex AudioSeekPointIndex {
			get;
		}
		...
		BindingList<ITermsOfUse> TermsOfUseList {
			get;
		}
		...
		BindingList<ICommercial> CommercialInfoList {
			get;
		}
		...
		BindingList<IEncryptionMethod> EncryptionMethodList {
			get;
		}
		...
		BindingList<IGroupIdentification> GroupIdentificationList {
			get;
		}
		...
		BindingList<IPrivateFrame> PrivateFrameList {
			get;
		}
		...
		BindingList<ISignature> SignatureList {
			get;
		}
		...
		IMusicianCreditsList MusicianCreditsList {
			get;
		}
		...
		BindingList<IAudioText> AudioTextList {
			get;
		}
